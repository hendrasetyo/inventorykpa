                    ...
                    <div class="card card-custom">
                        <div class="card-header py-3">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Data Kunjungan Teknisi</h3>
                            </div>
                            <div class="card-toolbar">
                                <!--begin::Button-->                            
                                @can('kunjunganteknisi-create')
                                <a href="{{ route('kunjunganteknisi.create') }}"
...
<script type="text/javascript">
    $(function () {          
          var table = $('.yajra-datatable').DataTable({
              ...
              scrollX:true,
              ajax: {
                    url : "{{ route('kunjunganteknisi.datatable') }}", 
                    type : "POST",
    ...
    function show_confirm(id){
        ...
        confirmButtonText: "Yes, Hapus!"
            ...
            if (result.value) {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('kunjunganteknisi.destroy') }}',
                    dataType: 'html',
