...
@section('content')
    ...
    <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header ">
                                <div class="card-title">
                                    ...
                                    <h3 class="card-label">Perjalanan Dinas</h3>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" method="post" action="{{ route('perjalanandinas.update', ['id'=>$id]) }}">
                                    @csrf
                                    @include('sales.perjalanandinas.partial._form-edit')
                                </form>
                            </div>
                            <!--end::Card-->
        ...
        @include('sales.perjalanandinas.modal.edit._form-before-action')
        @include('sales.perjalanandinas.modal.edit._form-after-action')
    @endsection
    @push('script')
        ...
        <script type="text/javascript">
            ...
            function submitBefore() {
                ...
                var asal_mana = document.getElementById('asal_mana').value;
                ...
                var jenis_transportasi = document.getElementById('jenis_transportasi').value;
                var penyedia_transportasi = document.getElementById('penyedia_transportasi').value;
                var waktu_berangkat = document.getElementById('waktu_berangkat').value;
                var nama_hotel = document.getElementById('nama_hotel').value;


                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.submitdinasedit') }}',
                    dataType: 'html',
                    headers: {
                    ...
                    data: {
                        ...
                        'penyedia_transportasi': penyedia_transportasi,
            ...
            function deletebefore(id) {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: 'POST',
                            url: '{{ route('perjalanandinas.deletedinasedit') }}',
                            dataType: 'html',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
            ...
            function editBefore(id) {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.editdinasedit') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function updateBefore(id) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.updatedinasedit') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function tabelBefore() {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.tabledinasedit') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function submitAfter() {
                ...
                var jenis_entertainment = document.getElementById('jenis_entertainment').value;
                var tujuan_entertainment = document.getElementById('tujuan_entertainment').value;

                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.submitentertainedit') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    data: {
                        ...
                        'nama': nama,
                        'jenis_entertainment': jenis_entertainment,
                        'tujuan_entertainment': tujuan_entertainment,
                        "_token": "{{ csrf_token() }}"
                    },
                    ...
                    success: function(data) {
                        ...
                        $('#nama_perusahaan').val('');
                        $('#nama').val('');
                        $('#jenis_entertainment').val('');
                        $('#tujuan_entertainment').val('');
            ...
            function tabelAfter() {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.tableentertainedit') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function deleteAfter(id) {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: 'POST',
                            url: '{{ route('perjalanandinas.deleteentertainedit') }}',
                            dataType: 'html',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
            ...
            function editAfter(id) {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.editentertainedit') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function updateAfter(id) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.updateentertainedit') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
