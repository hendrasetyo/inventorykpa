...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post"
                                ...
                                @csrf
                                @include('penjualan.pengirimanbarang._form-control', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
    ...
    function loadTempSJ(){
        $.ajax({
                type: 'POST',
                url: '{{ route('pengirimanbarang.loadtempsj') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
                    "id" : "",
    ...
    function destroy_detail(){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('pengirimanbarang.destroy_detail') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
    ...
    function editBarang(data_id){
        $.ajax({
                type: 'POST',
                url: '{{ route('pengirimanbarang.editbarang') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {id:data_id, "_token": "{{ csrf_token() }}"},
    ...
    function updateItem(){
        ...
        var so_detail_id = document.getElementById('so_detail_id').value;
        var qty = document.getElementById('qty').value;
        var keterangan = document.getElementById('keterangan').value;

        $.ajax({
                type: 'POST',
                url: '{{ route('pengirimanbarang.updatebarang') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
                    "id": id,
