                    ...
                    <div class="card card-custom">
                        <div class="card-header py-3">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Data Group Produk</h3>
                            </div>
                            <div class="card-toolbar">
                                ...
                                @can('productgroup-create')
                                <a href="{{ route('productgroup.create') }}" class="btn btn-primary font-weight-bolder">
