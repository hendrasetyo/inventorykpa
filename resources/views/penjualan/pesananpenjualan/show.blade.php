                    ...
                    <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
                        <div class="col-md-9">
                            <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                <h1 class="display-4 font-weight-boldest mb-10">PESANAN PENJUALAN</h1>
                            ...
                            <div class="d-flex justify-content-between pt-6">
                                <div class="d-flex flex-column flex-root">
                                    ...
                                    <span class="opacity-70">{{ $pesananpenjualan->customers->nama }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">SP No.</span>
                                    <span class="opacity-70">{{ $pesananpenjualan->kode }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">KOMODITAS</span>
                                    <span class="opacity-70">{{ $pesananpenjualan->komoditas->nama }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">KATEGORI</span>
                                    <span class="opacity-70">{{ $pesananpenjualan->kategoripesanan->nama }}</span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between pt-6">
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">ID PAKET</span>
                                    <span class="opacity-70">{{ $pesananpenjualan->id_paker }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">NAMA PAKET</span>
                                    <span class="opacity-70">{{ $pesananpenjualan->nama_paket }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">SUMBER DANA</span>
                                    <span class="opacity-70">{{ $pesananpenjualan->sumber_dana }} </span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">TAHUN ANGGARAN</span>
                                    <span class="opacity-70">{{ $pesananpenjualan->tahun_anggaran }} </span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between pt-6">
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">PEMESAN</span>
                                    <span class="opacity-70">{{ $pesananpenjualan->pemesan }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">PPK</span>
                                    <span class="opacity-70">{{ $pesananpenjualan->ppk }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                            ...
                            <div class="d-flex justify-content-between pt-6">
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">TANGGAL PESANAN CUSTOMER</span>
                                    <span class="opacity-70">{{ \Carbon\Carbon::parse($pesananpenjualan->tanggal_pesanan_customer)->format('d F Y') }}</span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-9">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach($pesananpenjualandetails as $a)
                    ...
                    <div class="row justify-content-center bg-gray-100 py-8 px-8 py-md-10 px-md-0">
                        <div class="col-md-9">
                            <div class="table-responsive">
                                ...
                                <br />
                                <h4>Keterangan :</h4>
                                <p>{{ $pesananpenjualan->keterangan }} </p>
                            </div>
                        </div>
                    </div>
                    <!-- end: Invoice footer-->
                            ...
                            <div class="card card-custom gutter-b">
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr class="font-weight-bolder">
                                                <td>{{ $pesananpenjualan->created_at }}</td>

                                                <td>{{ $pesananpenjualan->creator->name }}</td>
                                                <td>{{ $pesananpenjualan->updated_at }}</td>
                                                <td>{{ $pesananpenjualan->updater->name }}</td>
