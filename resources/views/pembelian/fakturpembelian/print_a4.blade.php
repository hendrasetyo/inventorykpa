    ...
    @for($i = 1; $i <= $totalPage; $i++) <table width=" 100%" style="margin-top: 0px; border-collapse:collapse">
        ...
        <tr>
            <td colspan="6" style="text-align: center; border-bottom: 1px solid black;">
                ...
                <h5 style="margin-top: 0px; margin-bottom: 5px;">JL Raya I Gusti Ngurah Rai LT.1 Blok A-1 No.11-12 Rt.001 Rw.007 Surabaya</h5>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td style='font-size: 70%; line-height:90%; text-align:right'><b>
                                    {{ number_format(floor($fakturpembelian->subtotal), 0, ',', '.') }}
                                </b></td>
                        </tr>
                        <tr>
                         ...
                         <tr>
                            ...
                            <td style='font-size: 70%; text-align:right'><b>
                                    {{ number_format(floor($fakturpembelian->ongkir), 0, ',', '.') }}
                                </b></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style='font-size: 70%; width: 5%;'><b>: Rp.</b></td>
                            <td style='font-size: 70%; text-align:right'><b>
                                    {{ number_format(floor($fakturpembelian->grandtotal), 0, ',', '.') }}
                                </b></td>
                        </tr>
                    </table>
