                    ...
                    <div class="card card-custom">
                        <div class="card-header py-3">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Data Kategori Supplier</h3>
                            </div>
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                @can('supplier-list')
                                <a href="{{ route('supplier.index') }}" class="btn btn-info font-weight-bolder mr-3">
                                ...
                                <a href="{{ route('suppliercategory.create') }}"
...
<script type="text/javascript">
    $(function () {
          ...
          var table = $('.yajra-datatable').DataTable({
              ...
              processing: true,
              serverSide: true,
              ajax: "{{ route('suppliercategory.index') }}",
              columns: [
    ...
    function show_confirm(data_id){
            $.ajax({
                type: 'POST',
                url: '{{ route('suppliercategory.delete') }}',
                dataType: 'html',
