    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Perjalanan Dinas</h5>
                ...
                <form class="form">
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal" id="tanggal" class="form-control"
                           value="{{\Carbon\Carbon::parse($dinas->tanggal)->format('Y-m-d')}}">
                    </div>
                    <div class="form-group">
                        <label for="">Dari</label>
                        <input type="text" name="asal_mana" id="asal_mana" class="form-control"
                             value="{{$dinas->asal_mana}}">
                    </div>
                    <div class="form-group">
                        <label for="">Ke</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="waktu_mulai" id="waktu_mulai" class="form-control"
                                    value="{{\Carbon\Carbon::parse($dinas->waktu_mulai)->format('H:i')}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="waktu_selesai" id="waktu_selesai" class="form-control"
                                    value="{{\Carbon\Carbon::parse($dinas->waktu_selesai)->format('H:i')}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jenis_transportasi" id="jenis_transportasi" class="form-control"
                             value="{{$dinas->jenis_transportasi}}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="penyedia_transportasi" id="penyedia_transportasi" class="form-control"
                            value="{{$dinas->penyedia_transportasi}}">
                    </div>

                    <div class="form-group">
                        <label for="">Waktu Berangkat</label>
                        <input type="time" name="waktu_berangkat" id="waktu_berangkat" class="form-control"
                        value="{{\Carbon\Carbon::parse($dinas->waktu_berangkat)->format('H:i')}}">
                    </div>

                    <div class="form-group">
                        <label for="">Nama Hotel</label>
                        <input type="text" name="nama_hotel" id="nama_hotel" value="{{$dinas->nama_hotel}}" class="form-control">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="submit" onclick="javascript:updateBefore({{$dinas->id}});" class="btn btn-primary font-weight-bold"
                         >Simpan</button>
