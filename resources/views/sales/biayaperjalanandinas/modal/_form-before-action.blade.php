            ...
            <div class="modal-body" style="height: 600px;">
                <form class="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="biaya_hotel" id="biaya_hotel" max="1000" class="form-control" required> 
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="biaya_makan" id="biaya_makan" class="form-control" required>
                    </div>

                    <div class="form-group">
                        <label for="">Biaya Laundry</label>
                        <input type="number" name="biaya_laundry" id="biaya_laundry" class="form-control" required>
                    </div>

                    <div class="form-group">
                        <label for="">Biaya Entertainment</label>
                        <input type="number" name="biaya_entertainment" id="biaya_entertainment" class="form-control" required>
                    </div>

                    <div class="form-group">
                        <label for="">Biaya Lainya </label>
                        <input type="number" name="biaya_lainya" id="biaya_lainya" class="form-control" required>
                    </div>
                </form>
            </div>
