                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Kategori Customer Update</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post"
                                action="{{ route('customercategory.edit', $customercategory) }}">
                                @csrf
                                @method('put')
                                @include('master.customercategory._form-control', ['submit' => 'Update'])
                            </form>
                        </div>
                        <!--end::Card-->
