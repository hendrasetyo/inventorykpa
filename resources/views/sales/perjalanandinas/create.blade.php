...
@section('content')
    ...
    <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" method="post" action="{{ route('perjalanandinas.store') }}">
                                    @csrf
                                    @include('sales.perjalanandinas.partial._form-add')
                                </form>
                            </div>
                            <!--end::Card-->
        ...
        @include('sales.perjalanandinas.modal._form-before-action')
        @include('sales.perjalanandinas.modal._form-after-action')
    @endsection
    @push('script')
        ...
        <script type="text/javascript">
            ...
            function submitBefore() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.submitdinas') }}',
                    dataType: 'html',
                    headers: {
            ...
            function deletebefore(id) {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: 'POST',
                            url: '{{ route('perjalanandinas.deletedinas') }}',
                            dataType: 'html',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
            ...
            function editBefore(id) {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.editdinas') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function updateBefore(id) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.updatedinas') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function tabelBefore() {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.tabledinas') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function submitAfter() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.submitentertain') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function tabelAfter() {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.tableentertain') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function deleteAfter(id) {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: 'POST',
                            url: '{{ route('perjalanandinas.deleteentertain') }}',
                            dataType: 'html',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
            ...
            function editAfter(id) {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.editentertain') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function updateAfter(id) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('perjalanandinas.updateentertain') }}',
                    dataType: 'html',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
