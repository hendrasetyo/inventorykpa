                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Sub Kategori Baru</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('productsubcategory.create') }}">
                                @csrf
                                @include('master.productsubcategory._form-control', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
