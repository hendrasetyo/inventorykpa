...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post"
                                action="{{ route('fakturpenjualan.create', $pengirimanbarang) }}">
                                @csrf
                                @include('penjualan.fakturpenjualan._form-control', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
    ...
    function editbiaya(){            
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('fakturpenjualan.editbiaya') }}',
                dataType: 'html',
    ...
    function updateBiaya(){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('fakturpenjualan.updatebiaya') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
                    "id_biaya": idbiaya,
    ...
    function hitungBiaya(){
        $.ajax({
                type: 'POST',
                url: '{{ route('fakturpenjualan.hitungbiaya') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
                     "_token": "{{ csrf_token() }}"
    ...
    function hitunggrandtotal() {
        $.ajax({
                type: 'POST',
                url: '{{ route('fakturpenjualan.hitunggrandtotal') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {                    
