                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Masukkan Tanggal Biaya Operational</h3>
                            </div>
                        ...
                        <!--begin::Form-->
                        <div class="card-body">
                            <form class="form" method="post" action="{{ route('laporanbiayaoperational.filter') }}">
                                @csrf
                                ...
                                <div class=" form-group">
                                    ...
                                    <select name="jenis_biaya_id" class="form-control" id="kt_select2_1">
