                    ...
                    <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
                        <div class="col-md-9">
                            <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                <h1 class="display-4 font-weight-boldest mb-10">FAKTUR PEMBELIAN</h1>
                                <div class="d-flex flex-column align-items-md-end px-0">
                                    ...
                                    <span class=" d-flex flex-column align-items-md-end opacity-70">
                                        <span>{{ $fakturpembelian->tanggal->format("d F Y") }}</span>
                                        <span>{{ $fakturpembelian->creator->name }}</span>
                                        <span
                                            class="font-weight-bold font-italic text-primary font-size-h3">{{ $fakturpembelian->kode }}</span>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between pt-6">
                                <div class="d-flex flex-column flex-root">
                                    ...
                                    <span class="opacity-70">{{ $fakturpembelian->suppliers->nama }}</span>
                                </div>

                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">PENERIMAAN BARANG</span>
                                    <span class="opacity-70">{{ $fakturpembelian->PB->kode }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                ...
                <div class="col-md-9">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($fakturpembeliandetails as $a)
            ...
            <div class="row justify-content-center bg-gray-100 py-8 px-8 py-md-10 px-md-0">
                <div class="col-md-9">
                    <div class="table-responsive">
                        ...
                        <br />
                        <h4>Keterangan :</h4>
                        <p>{{ $fakturpembelian->keterangan }} </p>
                    </div>
                </div>
            </div>
            <!-- end: Invoice footer-->
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr class="font-weight-bolder">
                                        <td>{{ $fakturpembelian->created_at }}</td>

                                        <td>{{ $fakturpembelian->creator->name }}</td>
                                        <td>{{ $fakturpembelian->updated_at }}</td>
                                        <td>{{ $fakturpembelian->updater->name }}</td>
            ...
            <div class="row justify-content-center py-8 px-8 py-md-10 px-md-0">
                ...
                <div class="col-md-9">
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-danger font-weight-bold" href="{{ url('pembelian/fakturpembelian') }}">Back
                        </a>
                    </div>
                </div>
            </div>
