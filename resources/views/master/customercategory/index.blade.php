                    ...
                    <div class="card card-custom">
                        <div class="card-header py-3">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Data Kategori Customer</h3>
                            </div>
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                @can('customer-list')
                                <a href="{{ route('customer.index') }}" class="btn btn-info font-weight-bolder mr-3">
                                ...
                                <a href="{{ route('customercategory.create') }}"
...
<script type="text/javascript">
    $(function () {
          ...
          var table = $('.yajra-datatable').DataTable({
              ...
              processing: true,
              serverSide: true,
              ajax: "{{ route('customercategory.index') }}",
              columns: [
    ...
    function show_confirm(data_id){
            $.ajax({
                type: 'POST',
                url: '{{ route('customercategory.delete') }}',
                dataType: 'html',
