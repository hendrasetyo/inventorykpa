<div class="card-body">    
    ...
    <div class="form-group">
        ...
        <textarea type="text" name="aktifitas" value="{{ old('aktifitas') }}"
        class="form-control" placeholder="Masukkan aktifitas"  id="" cols="30" rows="5" required></textarea>
    ...
    <div class="row">
        <div class="col-lg-12 ">
            <button type="submit" class="btn btn-success font-weight-bold mr-2 submit" id="save-jpeg"><i class="flaticon2-paperplane"></i>
               Save </button>
            <a href="{{ route('kunjunganteknisi.index') }}" class="btn btn-secondary font-weight-bold mr-2">
                Cancel</a>
        </div>
    </div>
</div>