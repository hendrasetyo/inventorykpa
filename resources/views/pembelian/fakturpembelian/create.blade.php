                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Faktur Pembelian</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post"
                                action="{{ route('fakturpembelian.create', $penerimaanbarang) }}">
                                @csrf
                                @include('pembelian.fakturpembelian._form-control', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
