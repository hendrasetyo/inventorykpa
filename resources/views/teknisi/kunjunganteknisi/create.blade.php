                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Tambah Kunjungan Teknisi</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="POST" action="{{ route('kunjunganteknisi.store') }}" enctype="multipart/form-data">
                                @csrf
                                @include('teknisi.partial._form-add')
                            </form>
