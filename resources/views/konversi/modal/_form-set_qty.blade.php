<div class="modal fade" id="setQtyModal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop"
    aria-hidden="true">
                ...
                <form action="{{ route('konversisatuan.inputqty') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-2">
                                <input type="number" class="form-control" id="qty_konversi"
                                    name="qty_konversi" max="{{$exp->qty}}" min="0" required/>
                            </div>
                        </div>                                              
                    </div>                
