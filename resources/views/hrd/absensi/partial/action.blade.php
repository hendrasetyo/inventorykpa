<div style="text-align:center;">
    <div class="d-flex flex-nowrap">
        ...
        <a href="#" onclick="updateStatus({{ $id }})" class="btn btn-outline-primary btn-sm ">
            Status
        </a>
        ...
        <a href="#" onclick="deleteData({{ $id }})"
            class="btn btn-icon btn-light btn-hover-primary btn-sm mr-3" data-toggle="modal"
            data-target="#kunjungansales">
            <span class="svg-icon svg-icon-md svg-icon-primary">
