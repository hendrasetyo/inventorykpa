                    ...
                    <div class="card card-custom">
                        <div class="card-header py-3 d-flex justify-content-between">
                            <div class="card-title">
                                    ...
                                    <h3 class="card-label">Laporan Biaya Operational</h3>
                                

                            </div>                           
                            
                            <div>
                                <form action="{{ route('laporanbiayaoperational.export') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="jenis_biaya_id" value="{{$form['jenis_biaya_id']}}">                                     
