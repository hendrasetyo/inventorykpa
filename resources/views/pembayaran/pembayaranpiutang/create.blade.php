                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('pembayaranpiutang.create', $piutang) }}">
                                @csrf
                                @include('pembayaran.pembayaranpiutang._form-control', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
