                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Input Expired Date</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post"
                                action="{{ route('pengirimanbarang.saveexp', ['stokExp'=>$stokExp,'pengirimanbarangdetail'=> $pengirimanbarangdetail]) }}">
                                @csrf
                                @include('penjualan.pengirimanbarang._form-exp', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
