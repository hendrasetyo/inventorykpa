...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post"
                                action="{{ route('penerimaanbarang.create', $pesananpembelian) }}">
                                @csrf
                                @include('pembelian.penerimaanbarang._form-control', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
    ...
    function pilihBarang(data_id){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('penerimaanbarang.setbarang') }}',
                dataType: 'html',
    ...
    function submitItem(){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('penerimaanbarang.inputtemppb') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
                    "detail_id": detail_id,
    ...
    function loadTempPB(){
        $.ajax({
                type: 'POST',
                url: '{{ route('penerimaanbarang.loadtemppb') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
                    "id" : "",
    ...
    function destroy_detail(){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('penerimaanbarang.destroy_detail') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
    ...
    function editBarang(data_id){
        $.ajax({
                type: 'POST',
                url: '{{ route('penerimaanbarang.editbarang') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {id:data_id, "_token": "{{ csrf_token() }}"},
    ...
    function updateItem(){
        ...
        var po_detail_id = document.getElementById('po_detail_id').value;
        var qty = document.getElementById('qty').value;
        var keterangan = document.getElementById('keterangan').value;

        $.ajax({
                type: 'POST',
                url: '{{ route('penerimaanbarang.updatebarang') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
                    "id": id,
