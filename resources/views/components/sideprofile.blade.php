        ...
        <div class="card-body pt-4">
            ...
            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('profile.edit') }}" class="navi-link py-4 {{ $type==1 ? 'active' : '' }}">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('profilepic.edit') }}" class="navi-link py-4 {{ $type==2 ? 'active' : '' }}">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo2\dist/../src/media/svg/icons\Home\Picture.svg--><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <polygon points="0 0 24 0 24 24 0 24" />
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('password.edit') }}" class="navi-link py-4  {{ $type==3 ? 'active' : '' }}">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon">
