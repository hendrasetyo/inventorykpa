                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Kategori Customer Baru</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('customercategory.create') }}">
                                @csrf
                                @include('master.customercategory._form-control', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
