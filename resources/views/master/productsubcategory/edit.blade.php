                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Sub Kategori Update</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post"
                                action="{{ route('productsubcategory.edit', $productsubcategory) }}">
                                @csrf
                                @method('put')
                                @include('master.productsubcategory._form-control', ['submit' => 'Update'])
                            </form>
                        </div>
                        <!--end::Card-->
