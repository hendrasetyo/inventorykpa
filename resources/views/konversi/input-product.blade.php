...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Konversi Produk</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" action="{{ route('konversisatuan.store') }}" method="POST">
                                @method('post')
                                @csrf
                                @include('konversi.partial.form-control', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
    ...
    let idtemp ={{ $temp->id }};
     ...
     $(function () {
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('konversisatuan.caribarang') }}",
            columns: [
    ...
    function pilihBarang(data_id){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('konversisatuan.setbarang') }}',
                dataType: 'html',
    ...
    function submitItem(){
        ...
        var qty = document.getElementById('stok_konversi').value;
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('konversisatuan.inputtempkonversi') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
    ...
    function loadTempPB(){
        $.ajax({
                type: 'POST',
                url: '{{ route('konversisatuan.loadkonversi') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
                    "id" : "",
    ...
    function destroy_detail(){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('konversisatuan.destroy_detail') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
    ...
    function editBarang(data_id){
        $.ajax({
                type: 'POST',
                url: '{{ route('konversisatuan.editbarang') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {id:data_id, "_token": "{{ csrf_token() }}"},
    ...
    function updateItem(){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('konversisatuan.updatebarang') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
                    "product_id": product_id,
