                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Kategori Supplier Update</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post"
                                action="{{ route('suppliercategory.edit', $suppliercategory) }}">
                                @csrf
                                @method('put')
                                @include('master.suppliercategory._form-control', ['submit' => 'Update'])
                            </form>
                        </div>
                        <!--end::Card-->
