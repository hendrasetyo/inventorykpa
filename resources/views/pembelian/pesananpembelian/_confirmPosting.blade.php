...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            @if($can_posting == "YES")
            <form id="destroy-form" action="{{ route('pesananpembelian.posted') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="{{ $id }}">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Posting Pesanan Pembelian?</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 " style="display: inline;">
                            <div class="align-middle">
                                Proses Posting jika penasan pembelian sudah final dan dapat dilakukan proses penerimaan
                                barang.
                            </div>
                        </div>
