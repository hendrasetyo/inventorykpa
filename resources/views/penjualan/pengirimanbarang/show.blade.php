                    ...
                    <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
                        <div class="col-md-9">
                            <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                <h1 class="display-4 font-weight-boldest mb-10">PENGIRIMAN BARANG</h1>
                            ...
                            <div class="d-flex justify-content-between pt-6">
                                <div class="d-flex flex-column flex-root">
                                    ...
                                    <span class="opacity-70">{{ $pengirimanbarang->customers->nama }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                    ...
                    <div class="row justify-content-center bg-gray-100 py-8 px-8 py-md-10 px-md-0">
                        <div class="col-md-9">
                            ...
                            <div class="table-responsive">
                                ...
                                <br />
                                <h4>Keterangan :</h4>
                                <p>{{ $pengirimanbarang->keterangan }} </p>
                            </div>
                        </div>
                    </div>
                    <!-- end: Invoice footer-->
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr class="font-weight-bolder">
                                                <td>{{ $pengirimanbarang->created_at }}</td>

                                                <td>{{ $pengirimanbarang->creator->name }}</td>
                                                <td>{{ $pengirimanbarang->updated_at }}</td>
                                                <td>{{ $pengirimanbarang->updater->name }}</td>
