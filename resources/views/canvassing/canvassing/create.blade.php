...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Canvassing</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('canvassing.create') }}">
                                @csrf
                                @include('canvassing.canvassing.partial._form-control', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
    ...
    <script type="text/javascript">
        $(function () {
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('canvassing.caribarang') }}",
            columns: [
    ...
    function pilihBarang(data_id){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('canvassing.setbarang') }}',
                dataType: 'html',
    ...
    function editBarang(data_id){
        $.ajax({
                type: 'POST',
                url: '{{ route('canvassing.editbarang') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {id:data_id, "_token": "{{ csrf_token() }}"},
    ...
    function submitItem(){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('canvassing.inputtempcanvas') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
    ...
    function updateItem(){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('canvassing.updatebarang') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
                    "id": id,
    ...
    function loadTempSO(){
        $.ajax({
                type: 'POST',
                url: '{{ route('canvassing.loadtempcanvas') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
                data: {
                    "id" : "",
    ...
    function destroy_detail(){
        ...
        $.ajax({
                type: 'POST',
                url: '{{ route('canvassing.destroy_detail') }}',
                dataType: 'html',
                headers: { 'X-CSRF-TOKEN' : $('meta[name="csrf-token"]').attr('content') },
