                    ...
                    <div class="card card-custom">
                        <div class="card-header py-3">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Data Canvassing Pengembalian</h3>
                            </div>
                            <div class="card-toolbar">
                                <!--begin::Button-->

                                @can('canvassing-create')
                                <a href="{{ route('canvassingpengembalian.listcanvas') }}"
                                    class="btn btn-primary font-weight-bolder ">
                                    <i class="flaticon2-add"></i>
                                    Canvassing Pengembalian
                                </a>
                                @endcan
...
<script type="text/javascript">
    $(function () {
          ...
          var table = $('.yajra-datatable').DataTable({
              ...
              serverSide: true,
              autoWidth: false,
              ajax: "{{ route('canvassingpengembalian.index') }}",
              columns: [
    ...
    function show_confirm(data_id){
        $.ajax({
            type: 'POST',
            url: '{{ route('canvassingpengembalian.delete') }}',
            dataType: 'html',
