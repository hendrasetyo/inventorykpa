@extends('layouts.app', ['title' => 'Navigations'])
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Create New Navigations</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('navigation.create') }}">
                                @csrf
                                @include('navigation._form-control', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
