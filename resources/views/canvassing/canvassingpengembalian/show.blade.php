                    ...
                    <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
                        <div class="col-md-9">
                            <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                <h1 class="display-4 font-weight-boldest mb-10">CANVASSING PENGEMBALIAN</h1>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-left font-weight-bold text-muted text-uppercase">Qty Sisa</th>
                                            <th class="text-left font-weight-bold text-muted text-uppercase">Qty Pengembalian
                                            </th>                                          
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr class="font-weight-boldest">
                                            ...
                                            <td class=" pt-7 text-left">{{ $a->qty_kirim }}</td>                                            
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
