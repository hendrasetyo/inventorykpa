    ...
    <div class="d-flex flex-column-fluid mt-10">
        ...
        <div class=" container ">
            ...
            <div class="alert alert-custom alert-danger fade show pb-2 pt-2" role="alert">
                <div class="alert-icon"><i class="flaticon-warning"></i></div>
                <div class="alert-text">{{ session('status_danger') }}</div>
                <div class="alert-close">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true"><i class="ki ki-close"></i></span>
                    </button>
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Masukkan Jenis Adjustment Stok</h3>
                            </div>
                        ...
                        <!--begin::Form-->
                        <div class="card-body">
                            <form class="form" method="post" action="{{ route('laporanstok.adjustmentstokresult') }}">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Jenis Adjustment Stok :</label>
                                        <select name="adjustment" class="form-control" id="kt_select2_1">
