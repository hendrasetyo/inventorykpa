                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Edit Navigations</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('navigation.update', $navigation) }}">
                                @csrf
                                @method('put')
                                @include('navigation._form-control', ['submit' => 'Update'])
                            </form>
                        </div>
                        <!--end::Card-->
