...
<!-- Modal-->
<div class="modal fade" id="kunjungansales" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          
            <form id="destroy-form" action="{{ route('kunjungansales.destroy') }}" method="POST">
                @csrf
                @method('delete')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 " style="display: inline;">
                            <div class="align-middle">
                                Deleting data kunjungan sales, will be permanently removed from
                                system.
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger font-weight-bold">Ya, Delete Sekarang ! </button>
                </div>
            </form>          
        </div>
    </div>
