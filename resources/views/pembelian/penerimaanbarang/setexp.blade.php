                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">
                                    Penerimaan Barang
                                    <small>{{ $penerimaanbarangdetail->penerimaanbarangs->kode }}</small>
                                </h3>
                            </div>
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                <a href="{{ route('penerimaanbarang.inputexp', $penerimaanbarang) }}"
                        ...
                        <div class="card-body">
                            <table>
                                <tr>
                                    <th>Produk</th>
                                    <td>:</td>
                                    <td>{{ $penerimaanbarangdetail->products->nama }}</td>
                                </tr>
                                <tr>
                                    <th>Qty Diterima</th>
                                    <td>:</td>
                                    <td>{{ $penerimaanbarangdetail->qty }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header py-3">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href="{{ route('penerimaanbarang.formsetexp', $penerimaanbarangdetail) }}"
