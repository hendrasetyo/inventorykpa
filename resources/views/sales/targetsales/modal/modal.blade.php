<div id="xcontohmodal">
    <div class="modal fade" id="tambahtargetsales" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Target Sales</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i aria-hidden="true" class="ki ki-close"></i>
                    </button>
                </div>
                <div class="modal-body" style="height: 400px;">
                    <form  method="POST" action="{{ route('targetsales.import') }}"  enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="">Download Template Excel</label><br>
                            <a  href="{{ asset('targetsales.xlsx') }}" download class="btn btn-primary btn-sm mr-2">
                        ...
                        <div class="form-group">
                            <label for="">Import Produk</label>
                            <input type="file" name="file" class="form-control">
                        </div>

                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-sm">Save</button>
                            <button type="button" class="btn btn-light-primary btn-sm font-weight-bold"
