<div style="text-align:center;">
    <div class="d-flex flex-nowrap">
        ...
        <a href="{{ $expUrl }}" class="btn btn-icon btn-light btn-hover-success btn-sm mr-3">
            <span class="svg-icon svg-icon-primary svg-icon-2x">
                <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo2\dist/../src/media/svg/icons\Code\Time-schedule.svg--><svg
