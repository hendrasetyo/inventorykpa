                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Tambah No Faktur Pajak</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('fakturpajak.create') }}">
                                @csrf
                                @include('master.fakturpajak._form-control', ['submit' => 'Save'])
                            </form>
                        </div>
                        <!--end::Card-->
