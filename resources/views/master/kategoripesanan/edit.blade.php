                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Kategori Surat Pesanan Update</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post"
                                action="{{ route('kategoripesanan.edit', $kategoripesanan) }}">
                                @csrf
                                @method('put')
                                @include('master.kategoripesanan._form-control', ['submit' => 'Update'])
                            </form>
                        </div>
                        <!--end::Card-->
