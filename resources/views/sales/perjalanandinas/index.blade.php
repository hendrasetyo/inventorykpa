                    ...
                    <div class="card card-custom">
                        <div class="card-header py-3">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                @can('perjalanandinas-create')                        
                                <a href="{{ route('perjalanandinas.create') }}"  class="btn btn-primary font-weight-bolder">
...
<script type="text/javascript">
    $(function () {          
          var table = $('.yajra-datatable').DataTable({
              ...
              serverSide: true,
              ajax: {
                url : "{{ route('perjalanandinas.datatable') }}", 
                type : "POST",
              ...
              columns: [
                //   {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                  {data: 'user', name: 'user'},
                  {data: 'tujuan_dinas', name: 'tujuan_dinas'},
