                    ...
                    <div class="card card-custom">
                        <div class="card-header py-3">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Data Kategori Surat Pesanan</h3>
                            </div>
                            <div class="card-toolbar">
                                <!--begin::Button-->

                                @can('kategoripesanan-create')
                                <a href="{{ route('kategoripesanan.create') }}"
                                    class="btn btn-primary font-weight-bolder">
                                    <i class="flaticon2-add"></i>
                                    Kategori Surat Pesanan
                                </a>
                                @endcan
...
<script type="text/javascript">
    $(function () {
          ...
          var table = $('.yajra-datatable').DataTable({
              ...
              processing: true,
              serverSide: true,
              ajax: "{{ route('kategoripesanan.index') }}",
              columns: [
    ...
    function show_confirm(data_id){
            $.ajax({
                type: 'POST',
                url: '{{ route('kategoripesanan.delete') }}',
                dataType: 'html',
