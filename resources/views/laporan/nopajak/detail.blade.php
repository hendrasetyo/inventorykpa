                    ...
                    <div class="card card-custom">
                        <div class="card-header py-3 d-flex justify-content-between">
                            <div class="card-title">
                                    ...
                                    <h3 class="card-label">Laporan No Faktur Pajak</h3>
                                

                            </div>                           
                            
                            <div>
                                <form action="{{ route('laporanfakturpajak.exportlogfaktur') }}" method="POST">
                                    @csrf
                                                    ...
                                                    @if ($item->jenis == 'FJ')
                                                        <div style="text-align:center;">
                                                            <div class="d-flex flex-nowrap">
                                                                <a href="{{ route('fakturpenjualan.showdata', ['fakturpenjualan' => $item->nofaktur_id]) }}" class="">
                                                                    [Detail]
                                                                </a>                                                    
                                                            </div>
                                                        </div>    
