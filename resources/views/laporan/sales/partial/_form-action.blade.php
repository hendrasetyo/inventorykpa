<div style="text-align:center;">
    <div class="d-flex flex-nowrap">
        @can('laporansales-show')
            <a href="{{ route('kunjungansales.show', ['kunjungansales' => $id]) }}"
            ...
            @can('chat-list')
                <a href="whatsapp://send?text=Assalamualaikum wr wb %0ABagaimana untuk hasil aktifitas {{ $aktifitas }} pada {{ $tanggal }} di {{ $customer }} ?&app_absent=0&phone={{ $nomor }}"
                    ...
                    <span
                        class="svg-icon svg-icon-md svg-icon-success"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo2\dist/../src/media/svg/icons\Communication\Chat2.svg--><svg
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24" />
