                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header ">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Merk Update</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('fakturpajak.edit', ['fakturpajak' => $fakturpajak->id]) }}">
                                @csrf
                                @method('put')
                                @include('master.fakturpajak._form-control', ['submit' => 'Update'])
                            </form>
                        </div>
                        <!--end::Card-->
