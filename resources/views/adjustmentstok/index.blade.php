            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="{{ route('adjustmentstok.index') }}" class="text-white text-hover-white opacity-75 hover-opacity-100">
                            Adjustment Stok </a>
                        <!--end::Item-->
                        ...
                        <div class="card-body ">
                            ...
                            <ul class="dashboard-tabs nav nav-pills nav-danger row row-paddingless m-0 p-0"
                                role="tablist">                               
                                  ...
                                  <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                                    <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center"
                                        href="{{ route('stokexpired.expired') }}">                                        
                                ...
                                <!--end::Item-->                              
                                  ...
                                  <!--begin::Item-->
                                  <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                                    <a href="{{ route('stoknonexpired.nonexpired') }}"
